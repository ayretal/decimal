...
START_TEST(is_equal_11) {
  ...
  s21_decimal dec3 = {0};
  s21_decimal dec4 = {0};
  s21_big_decimal dec5 = {0};
  s21_big_decimal dec6 = {0};
  s21_big_decimal dec7 = {0};
  s21_from_float_to_decimal(num1, &dec1);
  s21_from_float_to_decimal(num2, &dec2);
  binary_and(dec1, dec2);
  binary_xor(dec1, dec2);
  shift_left_one(dec1);
  shif_left(dec1, 3);
  binary_equal_zero(dec1);
  binary_addition(dec3, dec4);
  s21_set_sign(&dec3);
  s21_zero_decimal(&dec3);
  s21_s21_get_bit_big(dec5, 5);
  s21_s21_set_bit_big(&dec5, 4, 1);
  set_plus(&dec3);
  s21_import_to_big_decimal(dec3, &dec5);
  s21_import_to_small_decimal(&dec3, dec5);
  s21_is_big_decimal_not_empty(dec5);
  s21_increase_scale_big_decimal(&dec5, 1);
  s21_zero_big_decimal(&dec5);
  s21_is_greater_big_decimal(dec5, dec6);
  s21_is_greater_or_equal_big_decimal(dec5, dec6);
  s21_equation_bits_big_decimal(&dec5, &dec6);
  s21_sub_big_decimal(dec5, dec6, &dec7);
  s21_div_big_decimal(dec5, dec6, &dec7);
  s21_decreace_scale_big_decimal(&dec5, 1);
  s21_add_big_decimal(dec5, dec6, &dec7);
  int res = s21_is_equal(dec1, dec2);
  ck_assert_int_eq(res, 0);
}
END_TEST
...
Suite *suite_is_equal(void) {
  ...
  tcase_add_test(tc, is_equal_33);
  tcase_add_test(tc, is_equal_34);
  tcase_add_test(tc, is_equal_35);
  tcase_add_test(tc, is_equal_36);
  tcase_add_test(tc, is_equal_37);
  tcase_add_test(tc, is_equal_38);
  tcase_add_test(tc, is_equal_39);
  tcase_add_test(tc, is_equal_40);
  tcase_add_test(tc, is_equal_41);
  tcase_add_test(tc, is_equal_42);
  tcase_add_test(tc, is_equal_43);
  tcase_add_test(tc, is_equal_44);
  tcase_add_test(tc, is_equal_45);
  tcase_add_test(tc, is_equal_46);
  tcase_add_test(tc, is_equal_47);
  tcase_add_test(tc, is_equal_48);
  tcase_add_test(tc, is_equal_49);
  tcase_add_test(tc, is_equal_50);
  tcase_add_test(tc, is_equal_51);
  tcase_add_test(tc, is_equal_52);
  tcase_add_test(tc, is_equal_53);
  tcase_add_test(tc, is_equal_54);
  // tcase_add_test(tc, is_equal_55);
