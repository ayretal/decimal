...
START_TEST(sub_test_8) {
  ...
  s21_sub(number_1, number_2, &res);
  s21_from_decimal_to_int(res, &int_result);
  ck_assert_float_eq(int_result, answer);
}
END_TEST

START_TEST(sub_test_9) {
  int answer = 1234567710;
...
START_TEST(sub_test_10) {
  int answer = -2564;
  s21_decimal number_1 = {{2000, 0, 0, 2147483648}};  //-2564
...
START_TEST(sub_test_16) {
  ...
  s21_decimal res;
  int ret_s21 = s21_sub(number_1, number_2, &res);
...
START_TEST(sub_test_17) {
  ...
  s21_decimal res;
  int ret_dec = s21_sub(number_1, number_2, &res);
